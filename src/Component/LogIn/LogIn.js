        ...
        <div className="container">
            ...
            <div className="row">
                <button onClick={handleGoogleSignIn} className="BtnStyle">
                    <img className="imageHight" src={googleImage} alt="" />Continue with Google</button>
            </div>
            <div className="row">
                <button onClick={handleFacebookSignIn} className="BtnStyle">
                    <img className="imageHight" src={facebookImage} alt="" />Continue with Facebook</button>
            </div>
